...
* Copy the relevant parts of `.bashrc` from this repository into your own `.bashrc`
* This ensures colors generated by **wal** apply correctly to new terminal sessions
